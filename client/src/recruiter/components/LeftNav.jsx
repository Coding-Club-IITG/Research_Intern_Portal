    ...
    <div className="w-full md:w-20 lg:w-28 h-18 md:h-full shadow-md bg-white dark:bg-slate-800 text-gray-800 dark:text-white">
      <div className="md:space-y-4 md:mt-4 flex md:flex-col md:px-0 px-2 md:gap-2 gap-6 max-sm:items-center max-sm:justify-center overscroll-x-scroll">
        <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? "flex flex-col items-center cursor-pointer hover:bg-gray-200 dark:hover:bg-slate-700 rounded py-2 text-blue-700 dark:text-blue-300 text-xs md:text-base border-b-2 pb-2 border-blue-700 dark:border-blue-300"
              : "flex flex-col items-center cursor-pointer hover:bg-gray-200 dark:hover:bg-slate-700 rounded py-2 text-gray-600 dark:text-gray-300 text-xs md:text-base"
          }
          exact>
