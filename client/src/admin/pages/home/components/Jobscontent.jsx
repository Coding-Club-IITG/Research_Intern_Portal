...
const Jobs = [
  
    {
      ...
      "description": "Assist in research on machine learning algorithms and their application in healthcare.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Explore decentralized solutions and work on blockchain projects related to supply chain management.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Develop and test computer vision algorithms for automated image recognition systems.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Assist in research on NLP for improving sentiment analysis in social media content.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Work on developing robotic systems for autonomous navigation and object manipulation.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Conduct user experience testing and design interactive systems for enhancing user engagement.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Assist in cybersecurity research projects focused on developing secure systems for IoT devices.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Support AI courses by helping students with programming assignments and holding office hours.",
      "isActive": true,
    ...
    },
    {
      ...
      "description": "Analyze large-scale healthcare datasets for identifying trends and improving patient outcomes.",
      "isActive": false,
...
return (
    ...
    <Col  span={16}>
      <Card key = {i} title={Job.title} bordered={true}>
        ...
        <p><li style={{color:"#0000FF"}}>Professor Name : </li> {Job.prof_name}</p>
        <p><li style={{color:"#0000FF"}}>Job description : </li>{Job.description}</p>
        <p><li style={{color:"#0000FF"}}>Stipend : </li>{Job.stipend}</p>
        <p><li style={{color:"#0000FF"}}>Hours required : </li>{Job.hours_required}</p>
        <p><li style={{color:"#0000FF"}}>Total applicants : </li>{Job.total_applicants}</p>
        </div>
        <div style={{padding:"0px 10px"}}>
        <p><li style={{color:"#0000FF"}}>Job type : </li> {Job.type}</p>
        <p><li style={{color:"#0000FF"}}>Accepting : </li>{(Job.accepting)? "Yes": "No"}</p>
        <p><li style={{color:"#0000FF"}}>Status : </li> {(Job.isActive)? "Active": "Inactive"}</p>
        <p><li style={{color:"#0000FF"}}>Last Date : </li>{Job.last_date}</p>
        <p><li style={{color:"#0000FF"}}>Created at : </li>{Job.createdAt}</p>
        </div>
        <div>
