...
/**
 * @swagger
 * /api/v1/admin/controls/verify-recruiter:
 *   post:
 *     summary: Verify a recruiter
 *     description: This endpoint verifies a recruiter by ID.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: Recruiter verified successfully
 *                 data:
 ...
 *     description: This endpoint removes a recruiter by ID.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *                 message:
 *                   type: string
 *                   example: Recruiter removed successfully
 *       404:
 *         description: Recruiter not found
 *         content:
 *           application/json:
 ...
 *     description: This endpoint removes a student by ID.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
...
/**
 * @swagger
 * /api/v1/admin/controls/ban-recruiter:
 *   post:
 *     summary: Ban a recruiter
 *     description: This endpoint bans a recruiter by ID.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 ...
 *     responses:
 *       200:
 *         description: Recruiter banned successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                 message:
 *                   type: string
 *                   example: Recruiter banned successfully
 *                 data:
 *                   $ref: '#/components/schemas/Recruiter'
 *       404:
 *         description: Recruiter not found
 ...
 *     description: This endpoint deletes a job by ID.
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
